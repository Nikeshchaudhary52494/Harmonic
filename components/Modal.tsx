    ...
    return (
        <Dialog.Root open={isOpen} defaultOpen={isOpen} onOpenChange={onChange}>
            <Dialog.Portal>
                ...
                <Dialog.Content className='fixed top-[50%] left-[50%] max-h-full md:max-h-[90vh] md:w-[90vh] md:max-w-[450px] md:h-auto translate-x-[-50%] translate-y-[-50%] rounded-lg bg-[#171717] p-5 w-full h-full '>
